...
function render_image_template($file) {
    ...
    // Limitar el título a 20 caracteres y agregar "..." si es más largo
    $shortTitle = mb_strimwidth(esc_html($file->name), 0, 20, '...');
    ...
    <div class="file-item file-item-img">
        ...
        <div class="hover-general-information-img">
            <div class="img-title-preview-img">
